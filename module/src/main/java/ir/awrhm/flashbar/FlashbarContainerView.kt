...
import ir.awrhm.flashbar.Flashbar.Companion.DURATION_INDEFINITE
...
import ir.awrhm.flashbar.util.*
import ir.awrhm.flashbar.util.getNavigationBarPosition
import ir.awrhm.flashbar.util.getNavigationBarSizeInPx
import ir.awrhm.flashbar.util.getRootView
...
internal class FlashbarContainerView(context: Context)
    ...
    private val dismissRunnable = Runnable { dismissInternal(Flashbar.DismissEvent.TIMEOUT) }
